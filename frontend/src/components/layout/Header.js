...
const Header = () => {
  ...
  const { category = [] } = useSelector((state) => state.category); // Add a default value here
          ...
          >
            ...
            <div className="col-lg-2 col-md-2 col-sm-2 col-4">
              <Link to="/" className="header-1-logo text-center">
                <img src="/images/logo-mern.png" alt="" />
              </Link>
            </div>
            <div className="col-lg-5 col-md-5 col-sm-8 d-sm-block d-none my-div">
